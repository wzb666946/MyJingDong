...
import com.example.com.myjingdong.utils.ZoomImageView;
...
public class BigImgActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String images =  intent.getStringExtra("imageUrls");
        String[] split = images.split("\\|");
        imageUrls =Arrays.asList(split);;
    ...
    public class ImageScaleAdapter extends PagerAdapter
    {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            //使用glide加载图片
            Glide.with(BigImgActivity.this).load(imageUrls.get(position)).into(zoomImageView);
            //添加到容器container
